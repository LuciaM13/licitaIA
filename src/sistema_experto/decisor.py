...
para emitir alertas técnicas al licitador (ver ``src.sistema_experto.motor_clips``),
...
from src.sistema_experto.normalizacion import (
    factor_piezas,
    normalizar_tipo,
    normalizar_red,
...
from src.modelo.reglas.desempates import (
...
def resolver_decisiones(
    ...
    ``src.sistema_experto.explicaciones.generar_explicaciones``.
    """
