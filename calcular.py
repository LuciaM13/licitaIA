...
class ParametrosProyecto:
    ...
    precio_rep_adoquin_san_m2: float
    ...
    # Solo conceptos con precio existente
...
def calcular_presupuesto(parametros: ParametrosProyecto) -> dict:
    ...
    cap_rep_adoquin_san = parametros.rep_adoquin_san_m2 * parametros.precio_rep_adoquin_san_m2
    ...
    # Acometidas / SAN singulares con precios disponibles
    ...
    capitulo_01 = sum([
        ...
        cap_exc_manual_aba,
        cap_entibacion_aba,
        cap_carga_tierras_aba,
        cap_transporte_tierras_aba,
        cap_canon_tierras_aba,
        cap_arena_aba,
        cap_relleno_aba,
    ])
    capitulo_02 = sum([
        ...
        cap_exc_manual_san,
        cap_entibacion_san,
        cap_carga_tierras_san,
        cap_transporte_tierras_san,
        cap_canon_tierras_san,
        cap_arena_san,
        cap_relleno_san,
        cap_pozos,
        cap_imbornales,
    ...
    capitulo_03 = sum([
        cap_dem_bordillo_aba,
        cap_dem_acerado_aba,
        cap_dem_calzada_aba,
        cap_canon_mixto_aba,
        cap_rep_acerado_aba,
        cap_rep_bordillo_aba,
        cap_rep_adoquin_aba,
        cap_rep_rodadura_aba,
        cap_rep_base_pavimento_aba,
        cap_rep_hormigon_aba,
        cap_rep_base_granular_aba,
    ])
    capitulo_04 = sum([
        cap_dem_bordillo_san,
        cap_dem_acerado_san,
        cap_dem_calzada_san,
        ...
        cap_canon_mixto_san,
        cap_rep_acerado_san,
        cap_rep_bordillo_san,
        cap_rep_adoquin_san,
        cap_rep_rodadura_san,
        cap_rep_base_pavimento_san,
        cap_rep_hormigon_san,
        cap_rep_base_granular_san,
    ])
